(function(){CKEDITOR.dialog.add('youtube',
	...
	onOk:function(){
        ...
        var text='<iframe title="YouTube video player" class="youtube-player" type="text/html" width="480" height="390" src="http://www.youtube.com/embed/' + val +'" frameborder="0"></iframe>';
